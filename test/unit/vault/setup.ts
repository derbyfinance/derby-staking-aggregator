...
import { allProtocols, allDAIVaults, compoundUSDC, usdc, steth } from '@testhelp/addresses';
...
export const setupVault = deployments.createFixture(async (hre) => {
  ...
  await transferAndApproveDAI(vault.address, user, '100000000000000000000000'); // 100_000 dai
  ...
  return { vault, controller, dao, user, guardian, contract, ISTETH };
});
